          ...
          <Card className="shadow-sm border border-border/70">
            <CardHeader className="text-center sm:text-left">
              ...
              <CardDescription className="text-base text-muted-foreground leading-relaxed pt-2">
                Online-Zahlungen sind derzeit nicht verfügbar. Leistungen und Preise sind noch in Abstimmung. Du kannst deinen Anfragestatus im Reisebereich ansehen.
              </CardDescription>
            </CardHeader>
              ...
              <CardContent className="space-y-4 pt-2">
                <div className="p-4 border rounded-lg bg-muted/30 space-y-3">
                  ...
                  <div className="p-3 rounded-md bg-muted/60 text-xs text-muted-foreground leading-relaxed flex items-start gap-2">
                    ...
                    <span>
                      Stay Safe &amp; Brave verbindet selbstbestimmte Reisende mit einem persönlichen Local Mentor. Aktuell werden keine Zahlungen ausgelöst.
                    </span>
                  </div>
                </div>
              </CardContent>
